...
public:
  ...
  public:
    ...
    Pose T_me_from_world; //for rviz draw the inverse pose
 ...
 //   typedef tr1::shared_ptr<Line> LinePtr;
    ...
    public:
      ...
      // ToDo: This is ugly!
      // Eliminate code duplicates by moving most of this code into Edge and
    ...
    enum OptimizationType {POINTS, LINES, POINTS_AND_LINES};
...
//    typedef tr1::unordered_map<int,LinePtr>  LineTable;
    ...
    const tr1::unordered_set<int> & active_line_set() const
    {
      return active_line_set_;
    }
    ...
    const LineTable & line_table() const
    {
      return line_table_;
    }
  ...
  private:
    ...
    tr1::unordered_set<int> active_line_set_; // set of ids consisting of all lines found in the inner window
